...
export const PROJECTS: Project[] = [
  {
    ...
    whatItIs: 'Release owner and migration lead on an 8,000+ star orchestrator for parallel coding agents.',
    proof: '8,000+ stars. I own backend reliability, backward compatibility, and end-to-end correctness on a ground-up rewrite.',
