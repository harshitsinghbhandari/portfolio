...
Agent Orchestrator is an open-source orchestrator for parallel coding agents (roughly 7.6k stars). It plans tasks, spawns agents, and handles CI fixes, merge conflicts, and code reviews autonomously. My seat is release owner: I decide what ships to npm and I hold the publish token. I am also integration and migration lead on the ground-up rewrite, the person who owns end-to-end correctness, and the one who holds the whole-system map.
