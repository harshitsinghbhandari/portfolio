...
title: Donna
date: 2026-01-05
description: A local-first macOS ambient assistant that watches your screen, builds memory, and answers via Discord DM.
category: Local-first AI
status: Shipped, v0.3.0
role: Sole author
stack: Python, SQLite, FTS5, Ollama, Apple Vision
repo: https://github.com/harshitsinghbhandari/donna
tags: [local-first, ambient-intelligence, macos, memory]
---
