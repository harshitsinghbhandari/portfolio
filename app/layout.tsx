...
export const metadata: Metadata = {
  ...
  description:
    'Harshit Singh — building systems, agents, and local-first AI. IIT Bombay. Open source contributor to ComposioHQ/agent-orchestrator.',
  openGraph: {
    type: 'website',
    ...
    description:
      'Building systems, agents, and local-first AI. IIT Bombay. Open source contributor to ComposioHQ/agent-orchestrator.',
  },
  twitter: {
