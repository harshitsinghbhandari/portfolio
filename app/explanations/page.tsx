    ...
    <div className="container-page pb-24 pt-12 md:pt-16">
      <section>
        ...
        <article className="mt-10" aria-labelledby="video-spawning">
          <h2 id="video-spawning" className="text-[22px] font-semibold tracking-tight text-text sm:text-[27px]">
            <a
        ...
        <article className="mt-16 md:mt-20" aria-labelledby="video-overview">
          <h2 id="video-overview" className="text-[22px] font-semibold tracking-tight text-text sm:text-[27px]">
            <a
          ...
          <div className="mt-6 space-y-5 text-[17px] leading-[1.6] text-muted">
            <p>
